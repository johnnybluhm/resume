...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Technologies}{: Linux, Windows, Asp.net Core, Msbuild, Docker, Powershell, Git, MS SQL Server, Azure DevOps, Linq} \\ \vspace{4pt}
...
Spearheaded the resolution of timestamp anomalies in Splunk logging through a customized technical intervention; the new system improved time tracking accuracy by 500\%, elevating the dependability of logging operations. }       
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Developed .NET software applications for the Dish Network uplink center that allow internal teams to monitor over 6000 TV channels in real-time.}
