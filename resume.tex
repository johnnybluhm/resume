  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Identified and corrected memory leak in long running process. The fix allowed us to change the machine it was running on from an i2, to an i1 instance, saving around \$300/month.}
