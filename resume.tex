...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Technologies}{: Linux, Windows, Asp.net Core, Msbuild, Docker, Powershell, Git, MS SQL Server} \\ \vspace{4pt}
     \textbf{Other}{: Data Structures and Algorithms, Agile, Code Reviews, REST, Microservices, Distributed Systems, DevOps} \\ \vspace{4pt}
    }}
 \end{itemize}
 \vspace{-16pt}
