...
\section{Skills}
 \begin{itemize}[leftmargin=0.0in, label={}]
	...
	\textbf{Technologies}{: Linux $|$ ASP.NET $|$ Cosmos DB $|$ Azure DevOps $|$ Git $|$ Docker $|$ Node.js $|$ jQuery $|$ React $|$ Splunk}\\ \vspace{4pt}
	\textbf{Other}{: Data Structures and Algorithms $|$ Agile $|$ REST $|$ Microservices $|$ Distributed Systems $|$ API Design $|$ CI/CD} \\ \vspace{4pt}}}
 \end{itemize}
 \vspace{-16pt}
