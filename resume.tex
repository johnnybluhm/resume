...
\section{Experience}
  \resumeSubHeadingListStart
	...
	\resumeItem{Engineered an automated quote generation process, significantly accelerating testing workflows and reducing execution time from 20 minutes to 1 minute for routine tests.} 
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {GPA: 3.76}{University of Colorado Boulder}
  \resumeSubHeadingListEnd
