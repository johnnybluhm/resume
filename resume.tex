...
\section{Experience}
  \resumeSubHeadingListStart
      ...
      {Engineer II}{Remote}
      \resumeItemListStart
	\resumeItem{Engineered a system to cut down time to test new features from 20 minutes to 1 minute.}
	\resumeItem{Upgraded an Azure function to have an exception hierarchy and structured logging.}
