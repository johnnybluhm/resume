...
\resumeSubheading
      {Aspire General Insurance}{2024 -- Present}
      {Developer II}{Remote}
      \resumeItemListStart
        \resumeItem{Added client-side and server-side validation for the TypeScript quote model, paired with comprehensive Jest unit tests, significantly enhancing data integrity, reducing bugs, and accelerating development cycles.}
        \resumeItem{Contributed to the overhaul of an outdated quote sales UI by leveraging Next.js to introduce new features and improved functionality, resulting in a more user-friendly and efficient interface.}      
    \resumeItemListEnd
